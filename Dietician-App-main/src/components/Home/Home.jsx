	...
	return (
		<div className="mx-auto w-screen ">
			<aside className="relative w-screen overflow-hidden text-black rounded-lg sm:px-16 sm:py-6">
				<div className="relative w-full flex items-center justify-between max-sm:flex-col max-sm:p-0 z-10 max-w-screen-xl pb-20 mx-auto ">
...
<div className="w-[89vw] flex items-center justify-around  place-items-center bg-slate-200 rounded-2xl -ml-6 max-sm:w-[85vw] max-sm:flex-col max-sm:items-center max-sm:h-fit max-sm:m-0 ">
